...
"""
@Time    : 2023/10/25 19:38
@File    : semantic_segmentation.py
@Author  : zj
@Description: Full reference https://github.com/NVIDIA/TensorRT/blob/main/quickstart/SemanticSegmentation/tutorial-runtime.ipynb
"""
...
# How to convert fcn-resnet101.onnx -> fcn-resnet101.engine, see https://docs.nvidia.com/deeplearning/tensorrt/quick-start-guide/index.html#runtime
